          ...
          <div className="glass-card p-8 rounded-3xl mb-8 animate-slide-up">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              <div className="stat-card p-6 rounded-2xl">
                <div className="text-2xl md:text-3xl font-black text-gradient mb-2 break-words" data-testid="stat-top-artist-plays">
              ...
              <div className="stat-card p-6 rounded-2xl">
                <div className="text-2xl md:text-3xl font-black text-gradient mb-2 break-words" data-testid="stat-oldest-song">
                  {analysis.oldestSong}
                </div>
              ...
              <div className="stat-card p-6 rounded-2xl">
                <div className="text-2xl md:text-3xl font-black text-gradient mb-2 break-words" data-testid="stat-avg-tempo">
                  {analysis.avgTempo}
                </div>
              ...
              <div className="stat-card p-6 rounded-2xl">
                <div className="text-2xl md:text-3xl font-black text-gradient mb-2 break-words" data-testid="stat-unique-artists">
